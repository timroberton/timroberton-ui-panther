...
export function createBendsMap(edges, columns, nodeCoordMap, edgeCoordMap, s) {
    edges.forEach((edge) => {
        ...
        for (let i = 1; i < edgeCoords.nodeChain.length; i++) {
            // NOTE: Start at 1
            ...
            const isImmediate = segmentDirection === SegmentDirection.ImmediateDown ||
                segmentDirection === SegmentDirection.ImmediateUp;
