...
export default function AlertProvider() {
    ...
    return (<Show when={alertState()} keyed>
      {(keyedAlertState) => {
            return (<KDialog open={true} modal={true} onOpenChange={cancelAny}>
            <KDialog.Portal>
              ...
              <div class="fixed inset-0 z-50 flex items-center justify-center">
                <Switch>
                  <Match when={isComponentState(keyedAlertState) && keyedAlertState} keyed>
                    {(keyedComponentState) => {
                    return (<KDialog.Content class="ui-never-focusable z-50 rounded bg-base-100 shadow-lg outline-none">
                  ...
                  <Match when={isACPState(keyedAlertState) && keyedAlertState} keyed>
                    {(keyedACPState) => {
                    return (<KDialog.Content class="ui-pad ui-alert-w ui-never-focusable z-50 rounded bg-base-100 shadow-lg">
