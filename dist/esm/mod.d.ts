...
declare function openComponent<TProps, TReturn>(v: OpenComponentInput<TProps, TReturn>): Promise<TReturn | undefined>;
...
declare function ChartHolderAnimated<T extends Object>(p: Props$6<T>): solid_js.JSX.Element;
...
declare function ContainerHorizontalVertival_300px(p: ContainerProps): JSX.Element;
...
declare function Select<T extends string | number>(p: Props$1<T>): solid_js.JSX.Element;
...
export { type AlertComponentProps, AlertProvider, Button, ChartHolderAnimated, ChartHolderFixedHeight, ChartHolderFlex, Checkbox, ContainerFrameSideOrTop_700px, ContainerHorizontalVertival_300px, FrameSide, FrameSideMenu, FrameSideMenuSecondary, FrameSideOrTop_Lg, FrameSideOrTop_Md, FrameSideOrTop_Xl, FrameTop, FrameTopMenu, Input, Select, type SelectOption, Slider, openAlert, openComponent, openConfirm, openPrompt };
