import { isServer, createComponent, Dynamic, mergeProps as mergeProps$1, memo, Portal, insert, effect, setAttribute, template, use, delegateEvents, className, spread, style } from 'solid-js/web';
import { getOwner, onCleanup, DEV, createEffect, createRenderEffect, createMemo, $TRACK, untrack, createRoot, createSignal, mergeProps, splitProps, createContext, onMount, on, useContext, createUniqueId, Show, Switch, Match, children, For, createComputed, createComponent as createComponent$1 } from 'solid-js';
...
function createEventListener(targets, type, handler, options) {
  ...
  if (typeof targets === "function") createEffect(attachListeners);else createRenderEffect(attachListeners);
}
...
var _tmpl$$9 = /*#__PURE__*/template(`<div class="fixed inset-0 z-50 flex items-center justify-center">`),
  _tmpl$2$3 = /*#__PURE__*/template(`<div class=space-y-3>`),
  _tmpl$3$1 = /*#__PURE__*/template(`<div class=ui-space-y>`),
  _tmpl$4$1 = /*#__PURE__*/template(`<h2 class="text-lg font-700 leading-6 data-primary:text-primary data-neutral:text-neutral data-success:text-success data-danger:text-danger">`),
  ...
  _tmpl$8$1 = /*#__PURE__*/template(`<form id=promptForm class="ui-space-y w-full"><div class=ui-space-x-sm>`);
                ...
                insert(_el$, createComponent(Switch, {
                  get children() {
                    return [createComponent(Match, {
                      get when() {
                        return isComponentState(keyedAlertState) && keyedAlertState;
                      },
                      keyed: true,
                      children: keyedComponentState => {
                        return createComponent(Dialog.Content, {
                          "class": "ui-never-focusable z-50 rounded bg-base-100 shadow-lg outline-none",
                          get children() {
                      ...
                      get when() {
                        return isACPState(keyedAlertState) && keyedAlertState;
                      },
                      keyed: true,
                      children: keyedACPState => {
                        return createComponent(Dialog.Content, {
                          "class": "ui-pad ui-alert-w ui-never-focusable z-50 rounded bg-base-100 shadow-lg",
                          get children() {
                            var _el$2 = _tmpl$3$1();
                            insert(_el$2, createComponent(Show, {
                              get when() {
                                return keyedACPState.title || keyedACPState.text;
                              },
                              get children() {
                                var _el$3 = _tmpl$2$3();
                                insert(_el$3, createComponent(Show, {
                                  ...
                                  children: keyedTitle => {
                                    return (() => {
                                      ...
                                      effect(() => setAttribute(_el$4, "data-intent", keyedACPState.intent));
                                      return _el$4;
                                    })();
                                  }
                                }), null);
                            ...
                            insert(_el$2, createComponent(Switch, {
                              get children() {
                                return [createComponent(Match, {
                                  get when() {
                                    return isAlertState(keyedACPState) && keyedACPState;
                                  },
                                  keyed: true,
                                  children: keyedAlertState => {
                                    return (() => {
                                      ...
                                      insert(_el$6, createComponent(Button, {
                                        ...
                                        get children() {
                                          return keyedAlertState.closeButtonLabel ?? "Close";
                                        }
                                      }));
                                      return _el$6;
                                    })();
                                  ...
                                  get when() {
                                    return isConfirmState(keyedACPState) && keyedACPState;
                                  },
                                  keyed: true,
                                  children: keyedConfirmState => {
                                    return (() => {
                                      ...
                                      insert(_el$7, createComponent(Button, {
                                        ...
                                        get children() {
                                          return keyedConfirmState.confirmButtonLabel ?? "Confirm";
                                        }
                                      }), null);
                                      insert(_el$7, createComponent(Button, {
                                        onClick: () => {
                                  ...
                                  get when() {
                                    return isPromptState(keyedACPState) && keyedACPState;
                                  },
                                  keyed: true,
                                  children: keyedPromptState => {
                                    return createComponent(InnerForPrompt, {
                                      get pst() {
                                        return alertState();
                                      },
                                      close: v => {
...
function ChartHolderAnimated(p) {
  ...
  function render(obj) {
    ...
    const rcd = p.getChartRcd?.(obj) ?? new RectCoordsDims([0, 0, canvas.width, canvas.height]);
  ...
  createEffect(() => {
    ...
    tween.to(p.obj, 500).onUpdate(function (object) {
      render(object);
...
var _tmpl$$7 = /*#__PURE__*/template(`<div class=w-full><canvas class=w-full width=4000 height=0>`);
...
var _tmpl$$6 = /*#__PURE__*/template(`<div class="h-full w-full overflow-hidden"><canvas class=h-full width=2000 height=0>`);
...
var _tmpl$$5 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg class="h-4 w-4"viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=3.5 stroke-linecap=round stroke-linejoin=round><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M5 12l5 5l10 -10">`);
function Checkbox(p) {
  return createComponent(Checkbox$1, {
    ...
    get children() {
      return [createComponent(Checkbox$1.Control, {
...
var _tmpl$$4 = /*#__PURE__*/template(`<div class="h-full w-full @container"><div class="flex h-full w-full flex-col @[700px]:flex-row"><div class="h-0 w-full flex-1 @[700px]:h-full @[700px]:w-0">`),
  _tmpl$2$2 = /*#__PURE__*/template(`<div class="w-full flex-none @[700px]:h-full @[700px]:w-auto">`),
  _tmpl$3 = /*#__PURE__*/template(`<div class="h-full w-full @container"><div class="@[300px]:ui-space-x h-full w-full @[300px]:flex">`),
  _tmpl$4 = /*#__PURE__*/template(`<div class="flex h-full w-full"><div class="h-full flex-none"></div><div class="h-full w-0 flex-1">`),
  _tmpl$5 = /*#__PURE__*/template(`<div class="flex h-full w-full flex-col"><div class="h-0 w-full flex-1">`),
  _tmpl$6 = /*#__PURE__*/template(`<div class="w-full flex-none">`),
  _tmpl$7 = /*#__PURE__*/template(`<div class="flex h-full w-full flex-col md:flex-row"><div class="h-0 w-full flex-1 md:h-full md:w-0">`),
  _tmpl$8 = /*#__PURE__*/template(`<div class="w-full flex-none md:h-full md:w-auto">`),
  _tmpl$9 = /*#__PURE__*/template(`<div class="flex h-full w-full flex-col lg:flex-row"><div class="h-0 w-full flex-1 lg:h-full lg:w-0">`),
  _tmpl$10 = /*#__PURE__*/template(`<div class="w-full flex-none lg:h-full lg:w-auto">`),
  _tmpl$11 = /*#__PURE__*/template(`<div class="flex h-full w-full flex-col xl:flex-row"><div class="h-0 w-full flex-1 xl:h-full xl:w-0">`),
  _tmpl$12 = /*#__PURE__*/template(`<div class="w-full flex-none xl:h-full xl:w-auto">`),
  _tmpl$13 = /*#__PURE__*/template(`<div class="flex h-full w-full"><div class="h-full flex-none bg-base-content text-base-300"></div><div class="h-full w-0 flex-1">`),
  _tmpl$14 = /*#__PURE__*/template(`<div>`),
  _tmpl$15 = /*#__PURE__*/template(`<div class="flex h-full w-full"><div class="h-full flex-none space-y-3 bg-base-200 p-3 text-base-content-lighter"></div><div class="h-full w-0 flex-1">`),
  _tmpl$16 = /*#__PURE__*/template(`<div class="flex h-full w-full flex-col"><div class="flex w-full flex-none bg-base-content-lighter text-base-300"><div class=flex-1></div></div><div class="h-0 w-full flex-1">`);
    ...
    insert(_el$23, createComponent(For, {
      ...
      children: tab => {
        return (() => {
          ...
          effect(() => className(_el$25, `cursor-pointer select-none p-3 ${p.selected === tab.id ? "bg-base-content-focus text-base-100 underline" : "ui-hoverable"}`));
          return _el$25;
        })();
      }
    }));
    ...
    insert(_el$27, createComponent(For, {
      ...
      children: tab => {
        return (() => {
          ...
          effect(() => className(_el$29, `cursor-pointer select-none rounded-full px-3 py-1.5 ${p.selected === tab.id ? "bg-base-300 text-base-content" : "ui-hoverable"}`));
          return _el$29;
        })();
      }
    }));
    ...
    insert(_el$31, createComponent(For, {
      ...
      children: tab => {
        return (() => {
          ...
          effect(() => className(_el$34, `cursor-pointer select-none p-3 ${p.selected === tab.id ? "bg-base-content-lighter-focus text-base-100 underline" : "ui-hoverable"}`));
          return _el$34;
        })();
      }
    }), _el$32);
    insert(_el$31, createComponent(For, {
      ...
      children: sideTab => {
        return (() => {
          ...
          effect(() => className(_el$35, `cursor-pointer select-none p-3 ${p.selected === sideTab.id ? "bg-base-content-lighter-focus text-base-100 underline" : "ui-hoverable"}`));
          return _el$35;
        })();
      }
    }), null);
...
function createNumberFormatter(options) {
  ...
  return createMemo(() => new $488c6ddbf4ef74c2$export$cc77c4ff7e8673c5(locale(), access$1(options)));
}
...
var _tmpl$2$1 = /* @__PURE__ */template(`<div aria-hidden="true"><input type="text"><select tabindex="-1"><option>`);
...
var _tmpl$$1 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg class="h-5 w-5 p-0.5"viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=3 stroke-linecap=round stroke-linejoin=round><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M8 9l4 -4l4 4"></path><path d="M16 15l-4 4l-4 -4">`),
  _tmpl$2 = /*#__PURE__*/template(`<svg xmlns=http://www.w3.org/2000/svg class="h-4 w-4"viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=3 stroke-linecap=round stroke-linejoin=round><path stroke=none d="M0 0h24v24H0z"fill=none></path><path d="M5 12l5 5l10 -10">`);
function Select(p) {
  ...
  return createComponent(Select$1, {
    ...
    itemComponent: props => createComponent(Select$1.Item, {
      get item() {
        return props.item;
      },
...
function createSliderState(props) {
  ...
  const getPercentValue = percent => {
    ...
    return clamp$1(getRoundedValue(val), mergedProps.minValue(), mergedProps.maxValue());
  };
...
function Slider(p) {
  return createComponent(Slider$1, {
    ...
    get getValueLabel() {
      return p.valFormatter ? params => params.values.map(v => p.valFormatter(v)).join(", ") : undefined;
    },
    get children() {
      return [createComponent(Slider$1.Label, {
        ...
        get children() {
          return [createComponent(Slider$1.Fill, {
            "class": "absolute h-full cursor-pointer rounded-full backdrop-brightness-75"
          }), createComponent(Slider$1.Thumb, {
            "class": "ui-focusable ui-hoverable -top-1 block h-4 w-4 cursor-pointer rounded-full bg-base-content",
            get children() {
...
export { AlertProvider, Button, ChartHolderAnimated, ChartHolderFixedHeight, ChartHolderFlex, Checkbox, ContainerFrameSideOrTop_700px, ContainerHorizontalVertival_300px, FrameSide, FrameSideMenu, FrameSideMenuSecondary, FrameSideOrTop_Lg, FrameSideOrTop_Md, FrameSideOrTop_Xl, FrameTop, FrameTopMenu, Input, Select, Slider, openAlert, openComponent, openConfirm, openPrompt };
